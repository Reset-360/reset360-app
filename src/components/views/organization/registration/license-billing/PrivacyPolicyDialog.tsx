        ...
        <ScrollArea className="h-[60vh] px-6 pb-6">
          <div className="prose prose-sm max-w-none space-y-5 text-foreground text-sm leading-relaxed">
            <p>
              ...
              protect personal information in compliance with the Data Privacy
              Act of 2012 (Republic Act No. 10173) and its Implementing Rules
              and Regulations, as enforced by the National Privacy Commission
            ...
            <section className="bg-primary/10 border border-info/30 rounded-lg p-5">
              ...
              <p className="mb-3">
                ...
                including assessment responses and basic identifying details
                when required, for the purposes of self-reflection, screening,
                coaching support, and program planning. ADAPTS and other ERC
                assessments are not diagnostic or clinical tools.
              </p>
              <p className="mb-3">
              ...
              <p>
                ERC applies reasonable security measures to protect your data
                and retains it only for as long as necessary. You have the right
                to access, correct, or withdraw consent regarding your personal
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>
                  Responses to mental health screening and reflection tools
                </li>
            ...
            <section>
              ...
              <p className="mb-3">
                ERC collects and processes personal data solely for legitimate
                and specific purposes, including:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>
              ...
              <p className="mt-3 font-medium">
                ERC assessments, including ADAPTS, are not diagnostic or
                clinical tools and are not used for medical diagnosis, treatment
                planning, insurance determinations, or employment decisions.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-3">
                ERC processes personal data based on one or more of the
                following legal grounds:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>Your freely given, informed, and explicit consent</li>
                <li>
                  Fulfillment of contractual or program-related obligations
                </li>
                <li>Compliance with legal requirements</li>
                <li>
                  Legitimate interests of ERC, provided these do not override
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>
                  With authorized ERC personnel and program partners who are
                ...
                <li>
                  To protect the safety, rights, or welfare of individuals
                </li>
                <li>
            ...
            <section>
              ...
              <p className="mb-3">
                ERC retains personal data only for as long as necessary to
                fulfill the stated purposes or to comply with legal, regulatory,
            ...
            <section>
              ...
              <p>
                ...
                are conducted in accordance with applicable laws and
                institutional policies. Parental or guardian consent is obtained
                where required.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-3">
                ...
                legal, regulatory, or operational changes. Updates will be
                posted on ERC platforms with the revised effective date.
              </p>
              <p>
            ...
            <section>
              ...
              <p className="mb-3">
                For questions, concerns, or requests related to data privacy,
                you may contact:
              </p>
            ...
            <div className="border-t border-border pt-6 mt-8">
              <p className="text-center text-muted-foreground italic">
                ...
                for your privacy. This policy reflects our ongoing effort to
                make mental health reflection and support accessible while
