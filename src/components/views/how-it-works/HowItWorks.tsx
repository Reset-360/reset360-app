                ...
                >
                  ...
                  <div className="relative mb-6">
                    ...
                    >
                      ...
                      {/* Step number badge */}
                      <div
                        className={`md:hidden absolute -top-2 -left-10 w-10 h-10 rounded-full flex items-center justify-center text-white font-bold shadow-md ${
                    ...
                    {/* Step number badge */}
                    <div
                      className={`hidden md:flex absolute -top-2 -right-2 w-10 h-10 rounded-full items-center justify-center text-white font-bold shadow-md ${
                        isAccent ? 'gradient-accent' : 'gradient-primary'
                      }`}
                    >
                      {index + 1}
