import { TechniqueContent } from '@/constants/practice/content';
import { TechniqueIcon } from '@/constants/practice/TechniqueIcon';
import { TECHNIQUE_COLORS } from '@/constants/practice/techniques';
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        ...
        >
          <TechniqueIcon id={technique.id} className="text-green-600" />
        </div>
